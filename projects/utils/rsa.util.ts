...
export class RsaUtil {
    ...
    // 公钥
    private static publicKey = 'MIGfMA0GCSqGSIb3DQEBAQUAA4GNADCBiQKBgQDlSfUJ3rvG6YpGOyQIfQe/FA+asDeHjhiMPohdvcDUNomMRuUuK5Jrl7FYoJZFN0Qm' +
        'iTs2ZLQoQW8+YG5xLkFUJyBFuA6FctL9F8Soy1FgcoHXPAHok4npUco4uyt3f29OURTb14urjF6wdJT8YmKSZcDMWul/jrUWh5zS96MZowIDAQAB';
    ...
    public static encrpt(text: string, publicKey?: string): string {
        ...
        jsEncrypt.setPublicKey(publicKey || RsaUtil.publicKey);
    ...
    public static decrypt(text: string, privateKey?: string): string {
        const jsEncrypt = new JSEncrypt();
        jsEncrypt.setPrivateKey(privateKey || RsaUtil.privateKey);
